...
export const AboutInformation = (props) =>
    (
        <div className="paragraph" style={{"backgroundImage": `url(${props.backgroundImage})`}}>
                ...
                <p>
                    The purpose of this website is to first help me learn the entire full-stack cycle. In addition,
                    it will serve as a platform for me to deploy my applications.
                    Ideally I will eventually be containerizing my applications and hosting them
                    in the cloud, but that may take awhile.
                </p>
                <p>
